      ...
      <div class="row">
        ...
        <?php endif; ?>
          ...
          <div class="card rounded-0">
            <h3 class="card-header">Log In - Bruteforce</h3>
            <div class="card-body">
              <form role="form" action="bruteforce.php" method="get">
			  ...
			  <form role="form" action="index.php" method="get">
				<button type="submit" class="btn btn-success rounded-0">Home</button>
			  </form>
            </div>
          </div>
        </div>
